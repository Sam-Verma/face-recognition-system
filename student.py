...
class Student:
    def __init__(self,root):
        ...
        img_left = Image.open(r"C:\Users\samve\Downloads\Project\face-recognition-attendance\college_images\AdobeStock_303989091.JPEG")
        ...
        img_right = Image.open(r"C:\Users\samve\Downloads\Project\face-recognition-attendance\college_images\smart-attendance.JPG")
    ...
    def add_data(self):
        if self.var_dep.get() == "select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                conn = mysql.connector.connect(host="localhost",user="root",password="godofwar155", database="face_recognizer")      
