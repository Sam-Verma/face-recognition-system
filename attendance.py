...
class Attendance:
    def __init__(self,root):
        ...
        rollLabel.grid(row=0, column=2,padx=5, pady=8)
        ...
        # attendance label
        attendanceLabel = Label(left_inside_frame, text="Department",bg="white", font="comicsansns 11 bold")
    ...
    def exportCsv(self):
        try:
            ...
            with open(fln, mode="w", newline="") as myfile:
                ...
                for i in mydata:
                    # write row act like append in file handling
                    exp_write.writerow(i)
                messagebox.showinfo("Data Export", "Youe data exported to "+os.path.basename(fln)+ "successfully")
