...
class Developer:
    def __init__(self,root):
        ...
        # profile picture
        img_top1 = Image.open(r"college_images\myimage.png")
        ...
        # developer info
        dev_label = Label(main_frame, text="Hello My Name Is Aman", font=("times new roman", 20, "bold"), bg="white")
        dev_label.place(x=0, y=5)
        
        dev_label = Label(main_frame, text="I am Fresher", font=("times new roman", 20, "bold"), bg="white")
